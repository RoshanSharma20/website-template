        ...
        <div>
            ...
            <footer className="text-center lg:text-left bg-gray-300 text-gray-600 mt-9">
                    ...
                    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="">
                            <h6 className=" uppercase font-semibold mb-4 flex items-center justify-center md:justify-start">
                                ...
                                <span className="text-center m-2">Logo</span>
                            </h6>
                            <p>
                        ...
                        <div className="">
                            ...
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Product Name</a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Product Name</a>
                            </p>
                        ...
                        <div className="">
                            ...
                            <p className="flex items-center align-start justify-center md:justify-start mb-4">
                                Logo (L)
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. necessitatibus, quaerat laborum tempora accusamus nobis. Bangalore – 560 090
                                Karnataka, India
                            </p>
                            <p className="flex items-center justify-center md:justify-start mb-4">
                                ...
                                <a href="/" target="_blank">info@logo.com</a>
                            </p>
                            <p className="flex items-center justify-center md:justify-start mb-4">
                                ...
                                <a href="tel:+91 80 xxxxxxx">+91-80-xxxxxxx, </a> <a href="tel:+91 80 xxxxxxx">xxxxxxx</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div className="text-center p-6 bg-gray-400 /">
                    <span>© Copyright:</span>
                    <a className="text-gray-600 font-semibold" href="/">Logo</a>
                </div>
            </footer>
